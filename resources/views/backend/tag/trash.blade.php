@extends('layouts.backend') @section('title','Trash') @section('content')
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>
                            <form action="{{route('backend.tag.restore',$record->id)}}" method="post" style="display:inline-block">
                                @csrf
                                <input type="submit" class="btn btn-primary" value="Restore">
                            </form>
                            <form action="{{route('backend.tag.force_delete',$record->id)}}" method="post" style="display:inline-block">
                            @method("delete")
                                @csrf
