            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$d->created_at}}</td>
                        <th><a href="{{route('backend.brand.show',$d->id)}}">ViewDetails</a>
                            <a href="{{route('backend.brand.edit',$d->id)}}">Edit</a>
                            <form action="{{route('backend.brand.destroy',$d->id)}}" method="post">
