...
class TagController extends BackendBaseController
{
    ...
    public function show($id)
    {
        ...
        return view($this->base_view.'show',compact('data'));
    }
    ...
    public function trash()
    {
        ...
        return view($this->base_view.'trash', compact('data'));
    ...
    public function restore(Request $request, $id)
    {
        try{
            ...
            if(!$data['record'])
            {
                ...
                {
                $data['record']->restore();
                request()->session()->flash('sucess',"Restored Sucessfully");
    ...
    public function permanentDelete($id)
    {
        ...
        {
            request()->session()->flash('sucess',"Successfully Deleted");
